...
const main = async () => {
    ...
    try {
        ...
        let query = `select top 10 c.id, c.firstName, c.lastName, c.displayName, a.id as addressId, a.street, a.city, a.state, a.zip, e.id as emailId, e.email, p.id as phoneId, p.phoneNumber
            from dbo.contacts c
